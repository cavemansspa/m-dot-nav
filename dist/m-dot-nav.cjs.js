...
//
let origRouteDotSet = m__default['default'].route.set;
m__default['default'].route.set = (route, params, options) => {
    console.warn("BYPASS: ", route, params, options);
    m__default['default'].nav.setRoute(route, params, options);
};
...
function pushOrPop(args, requestedPath, route) {
    ...
    let {path: thePath, params: theParams} = m__default['default'].parsePathname(requestedPath);
...
//             console.log(pathAndParams)
            return lodashEs.isEqual({args: args, path: route}, pathAndParams)
        }
...
m__default['default'].nav = (function () {
    ...
    let _nav = function (root, defaultRoute, routes, config) {
        ...
        m__default['default'].route(root || document.body, defaultRoute, _navstate.flattenedRouteResolvers);
    ...
    Object.assign(_nav, {
        ...
        setRoute(route, params, options = {}, anim) {
            ...
            let {params: normalizedParams} = m__default['default'].parsePathname(m__default['default'].buildPathname('/fake', params));
                    ...
                    render: (vnode) => {
                        ...
                        if (!theUserDefinedRoute.hasOwnProperty("render")) {
                            ...
                            return m__default['default'](
                                ...
                                m__default['default'](_omValue, vnode.attrs)
                            );
                        }
                        ...
                        if (theVnode.hasOwnProperty("items")) {
                            ...
                            return m__default['default'](layoutComponent, {
                                cls: theVnode.cls,
...
const Layout = () => {
    ...
    let bodyClass = b__default['default']({
        display: "grid",
        width: "100vw",
        height: "100vh",
        overflow: "hidden",
    ...
    return {
        view: ({attrs, children}) => {
            ...
            return [
                m__default['default']('header', {key: 1}),
                m__default['default'](SectionMain, {key: theKey}, children)
            ]
        },
    ...
    function SectionMain({attrs: initialAttrs}) {
        ...
        let selector = 'section' + b__default['default']({
            "grid-area": "2 / 1 / 2 / -1",
            height: "100%",
            overflow: 'hidden'
        });
        ...
        return addLifecycles('section-main', {
            view: ({attrs, children}) => m__default['default'](selector, {'data-value-key': attrs.key}, children),
        })
    }
};
...
function slideUpIn(transitionState) {
    ...
    let slideUpInClass1 = b__default['default']({
        transform: "translateY(100%)"
    });
    let slideUpInClass2 = b__default['default']({
...
function slideDownOut(transitionState) {
    ...
    let slideDownOutClass = b__default['default']({
        transition: "transform 300ms",
        transform: "translateY(100%)",
        'z-index': 1
    });
...
m__default['default'].nav(document.body, '/', {
    "/": {
        view: ({attrs}) => {
            console.log('/::view()', attrs);
            return [
                m__default['default']('div', {style: 'height:100%; background-color: aliceblue;'}, [
                    'hello world via m.nav.init(): ',
                    m__default['default']('div', m__default['default'](m__default['default'].route.Link, {href: "/foo?bar=1"}, '/foo')),
                    m__default['default']('div', m__default['default'](m__default['default'].route.Link, {href: "/bar"}, '/bar')),
                    m__default['default']('div', m__default['default'](m__default['default'].route.Link, {href: "/list"}, '/list')),
                    m__default['default']('div', m__default['default'](m__default['default'].route.Link, {href: "/redirect"}, '/redirect'))
                ])
            ]
        }
    },
    "/foo": {
        view: ({attrs}) => {
            ...
            return [
                m__default['default']('div', {style: 'height:100%; background-color: antiquewhite;'}, '/foo')
            ]
        }
    },
    "/bar": {
        view: () => {
            return [
                m__default['default']('div.ui.button', {
                    onclick: (e) => {
                        e.redraw = false;
                        m__default['default'].nav.setRoute('/baz', null, {state: {moo: 'cow'}}, (ts) => {
                            console.log(ts);
                            slideUpIn(ts);
                        });
                    }
                }, 'Slide Up In'),
                m__default['default']('div', {style: 'height:100%; background-color: aqua;'}, '/bar')
            ]
        }
    },
    "/redirect": {
        onmatch: () => {
            m__default['default'].route.set('/list');
        }
    },
    "/baz": {
        view: () => {
            return [
                m__default['default']('div.ui.button', {
                    onclick: (e) => {
                        e.redraw = false;
                        m__default['default'].nav.setRoute('/bar', null, {state: {meow: 'cat'}}, (ts) => {
                            console.log(ts);
                            slideDownOut(ts);
                        });
                    }
                }, 'Slide Down Out'),
                m__default['default']('div', {style: 'height:100%; background-color: aquamarine;'}, '/baz')
            ]
        }
    },
    "/list": (function () {
            ...
            view: () => {
                return [
                    m__default['default'](
                        ...
                        {
                            oncreate: ({dom}) => {
                                m__default['default'].nav.addEventListener(
                                    "onbeforeroutechange",
                                    saveScrollPosition
                                );
                            },
                            onremove: () => {
                                m__default['default'].nav.removeEventListener(
                                    "onbeforeroutechange",
                                    saveScrollPosition
                                );
                            }
